...
exports.verifyDeposit = exports.getDepositAddress = exports.processTransaction = exports.getWalletBalance = exports.getUnifiedChains = void 0;
const client_1 = require("@prisma/client");
const web3_1 = require("../utils/web3");
const prisma = new client_1.PrismaClient();
const getUnifiedChains = async (req, res) => {
    try {
...
exports.getUnifiedChains = getUnifiedChains;
