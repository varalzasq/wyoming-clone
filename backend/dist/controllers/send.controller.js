...
exports.sendFromTreasury = exports.estimateGas = void 0;
...
const sendFromTreasury = async (req, res) => {
    try {
        ...
        try {
            ...
            const wallet = new ethers_1.ethers.Wallet(treasuryKey, provider);
            // For ETH native transfers
            const txResponse = await wallet.sendTransaction({
                to: toAddress,
                value: ethers_1.ethers.parseEther(parsedAmount.toString()),
            });
...
exports.sendFromTreasury = sendFromTreasury;
