...
export const processSwap = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getSwapQuote = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { fromSymbol, toSymbol, fromAmount } = req.query as {
      fromSymbol: string;
      toSymbol: string;
      fromAmount: string;
    };
